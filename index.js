...
const ownerNumber = ['50935959059']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("DRINX-MD~", '');
...
console.log("CONNECTING DRINX_MD🧬...");
...
let up = `*╭──────────────●●►*
> *➺drinx-md ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ Alix esca✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs❁*

*https://whatsapp.com/channel/0029VbBEGYMGJP8NpOJ6eS2A*

> *❁ᴊᴏɪɴ ᴏᴜʀ telegram ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs❁*

*https://t.me/DRINX_MD*

*╭⊱✫🐲 DRINX-MD 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *DRINX-MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *Alix ESCA🇭🇹*
*│✫➠ - 🌐URL:* *https://github.com/boss-Alix/DRINX-MD*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ufr0mz.jpeg` }, caption: up })
