...
zokou({nomCom : "igdl" , categorie : "Download"},async (dest , zk , commandeOptions)=>{
  ...
  try {
    ...
    zk.sendMessage(dest,{video : {url : igvid.data.result[0].url},caption : "ig video downloader powered by *DRINX-md*",gifPlayback : false },{quoted : ms}) 
        ...
        zk.sendMessage(dest,{image : {url : igvid.data.result[0].url},caption : "ig image downloader powered by *DRINX-md*"})
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.hd  }, caption: 'facebook video downloader powered by *DRINX-md*' }, { quoted: ms });
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.sd  }, caption: 'facebook video downloader powered by *DRINX-md*' }, { quoted: ms });
