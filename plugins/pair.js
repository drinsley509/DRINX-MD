...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example : .Pair +50935959059*");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://drinx-mdsession.onrender.com/pair?number=${q}`);
        ...
        const doneMessage = "> *DRINX-MD PAIR COMPLETED*";
