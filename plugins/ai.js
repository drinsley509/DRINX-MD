...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/l8oi3k.jpeg'; // Remplacez par l'URL de votre image AI
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/l8oi3k.jpeg'; // Replace with a valid image URL
